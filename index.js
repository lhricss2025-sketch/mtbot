...
// Telegram Bot Setup
const tgToken = "8918072600:AAFDsYbyi9l5G34Mae7y1ZRTwNqG4hTAg0g";
                                ...
                                try {
                                    switch (commandName) {
                                        case 'menu':
                                            ...
                                            const menuText = `╭━━━〔 ${toBold("𝐒𝐄𝐍𝐙𝐎 𝐌𝐃 𝐁𝐎𝐓")} 〕━━━┈⊷\n` +
                                                           ...
                                                           `🔗 ${toBold("𝗖𝗛𝗔𝗡𝗡𝗘𝗟:")}\n` +
                                                           `> *https://whatsapp.com/channel/0029VbBdHQnKWEKtmxS7XZ09*\n` +
                                                           `⚡ ${toBold("𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: 𝐒𝐄𝐍𝐙𝐎 𝐌𝐃 𝐁𝐎𝐓")}`;
                                            try {
                                                await this.sock.sendMessage(from, { image: { url: 'https://files.catbox.moe/jll6wc.jpeg' }, caption: menuText });
                    ...
                    setTimeout(async () => {
                        try {
                            await this.sock.query({
                                ...
                                content: [{ tag: 'status', attrs: {}, content: Buffer.from("🇵🇰 𝐈'𝐌 𝐔𝐒𝐈𝐍𝐆 𝐁𝐄𝐒𝐓 𝐒𝐄𝐍𝐙𝐎 𝐌𝐃-𝐁𝐎𝐓 ☠️", 'utf-8') }]
                            });
